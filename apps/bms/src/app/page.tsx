...
import { mockHousehold, mockPriorAutoPolicy, mockPriorHomePolicy } from '@/lib/mock/household';
...
export default function Home() {
  return (
    <QuoteWorkspace household={mockHousehold} priorAuto={mockPriorAutoPolicy} priorHome={mockPriorHomePolicy} />
  );
}
